...
part 'price_suggestion_record.g.dart';
...
class PriceSuggestionRecord {
  /// Returns a new [PriceSuggestionRecord] instance.
  ...
  final String runId;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is PriceSuggestionRecord &&
      other.action == action &&
    ...
    int get hashCode =>
        ...
        costReductionWhatifMargin.hashCode +
        currentPrice.hashCode +
        effectivePrice.hashCode +
        explanation.hashCode +
        foodCostPct.hashCode +
        guardClips.hashCode +
        itemName.hashCode +
        key.hashCode +
        marginPct.hashCode +
        peerComparison.hashCode +
        popularityShare.hashCode +
        priceChangedInWindow.hashCode +
        suggestedDeltaAbs.hashCode +
        suggestedDeltaPct.hashCode +
  ...
  factory PriceSuggestionRecord.fromJson(Map<String, dynamic> json) => _$PriceSuggestionRecordFromJson(json);

  Map<String, dynamic> toJson() => _$PriceSuggestionRecordToJson(this);
