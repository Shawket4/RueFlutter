...
part 'upsert_drink_recipe_request.g.dart';
...
class UpsertDrinkRecipeRequest {
  /// Returns a new [UpsertDrinkRecipeRequest] instance.
  ...
  final String sizeLabel;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is UpsertDrinkRecipeRequest &&
  ...
  factory UpsertDrinkRecipeRequest.fromJson(Map<String, dynamic> json) => _$UpsertDrinkRecipeRequestFromJson(json);

  Map<String, dynamic> toJson() => _$UpsertDrinkRecipeRequestToJson(this);
