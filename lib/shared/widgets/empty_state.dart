...
/// The one empty-state pattern: icon in a soft circle, title, optional body,
/// optional action. Replaces the Lottie-vs-text-vs-column inconsistency.
          ...
          child: Column(
            ...
            children: [
              Container(
                ...
                height: 72,
                decoration:
                    BoxDecoration(color: t.surfaceAlt, shape: BoxShape.circle),
