...
abstract class _$OtpRequestResponseCWProxy {
  OtpRequestResponse debugCode(String? debugCode);
  ...
  /// ````
  OtpRequestResponse call({String? debugCode, bool sent});
}
...
class _$OtpRequestResponseCWProxyImpl implements _$OtpRequestResponseCWProxy {
  ...
  @override
  OtpRequestResponse debugCode(String? debugCode) => this(debugCode: debugCode);
  ...
  OtpRequestResponse call({
    Object? debugCode = const $CopyWithPlaceholder(),
    Object? sent = const $CopyWithPlaceholder(),
  }) {
    return OtpRequestResponse(
      debugCode: debugCode == const $CopyWithPlaceholder()
          ? _value.debugCode
...
OtpRequestResponse _$OtpRequestResponseFromJson(Map<String, dynamic> json) =>
    $checkedCreate('OtpRequestResponse', json, ($checkedConvert) {
      ...
      final val = OtpRequestResponse(
        debugCode: $checkedConvert('debug_code', (v) => v as String?),
        sent: $checkedConvert('sent', (v) => v as bool),
      );
      return val;
    }, fieldKeyMap: const {'debugCode': 'debug_code'});

Map<String, dynamic> _$OtpRequestResponseToJson(OtpRequestResponse instance) =>
    <String, dynamic>{'debug_code': ?instance.debugCode, 'sent': instance.sent};
